...
interface VideoEffectsState {
  ...
  cardWidthPercent: number; // 30-90, % of frame width
}
...
function CaptionPreview({
  ...
  return (
    <span
      className={`text-lg font-bold text-center px-3 py-1.5 rounded leading-tight inline-block w-full ${animClass}`}
      style={{
        color: color,
        textShadow: outline
            ...
            <div>
              ...
              <div className="space-y-4 pl-6">
                ...
                <SettingRow
                  icon={Maximize2}
                  label="Card Width"
                  description={`${effects.cardWidthPercent}% of frame width`}
                >
                  <RangeSlider
