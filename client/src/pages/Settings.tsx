                      ...
                      <CardContent className="space-y-6">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-zinc-500 mb-3">
                            Template for video descriptions. Use{" "}
                            <code className="text-emerald-400">
                              {"{title}"}
                            </code>{" "}
                            as a placeholder for the video title.
                          </p>
                          <textarea
                            ...
                            placeholder="Shorts auto-generated by Commissioner"
                            rows={3}
                            className="w-full px-4 py-3 bg-zinc-900 border border-zinc-800 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:border-zinc-600 transition-colors text-sm resize-none"
                          />
                        </div>
